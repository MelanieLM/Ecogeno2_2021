...
#Error in base::try(ps_ccpna$CCA$eig, silent = TRUE) :
#object 'ps_ccpna' not found
...
all(rownames(seqtabAll) %in% Meta_donnes$SampleID) # TRUE
```
...
Meta_donnes <- Meta_donnes[rownames(seqtabAll), keep.cols]
```
```{r}
