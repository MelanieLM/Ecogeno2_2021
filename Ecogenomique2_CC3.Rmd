...
###################################################################################################
```{r}
samdf <- read.csv("https://github.com/MelanieLM/Ecogeno2_2021/blob/master/filereport_read_run_PRJEB44699_tsv%20(6).txt",header=TRUE)
